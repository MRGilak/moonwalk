...
This exact logic has been implemented in the function [optimalControlSolver](https://github.com/MRGilak/Optimal-Control/blob/main/Codes/optimalControlSolver.m). Here, we go over the variables, inputs and outputs of the function.
...
- Free time support has been added. You can use the available options to set it up. Take a look at [Free time CSTR](https://github.com/MRGilak/Optimal-Control/blob/main/Codes/CSTR_freeTf.m) to see how to use it 
...
- Three sample scripts have been provided:
   1. [demo.m](https://github.com/MRGilak/Optimal-Control/blob/main/Codes/demo.m) contains a linear system with two states and two inputs.
   2. [CSTR.m](https://github.com/MRGilak/Optimal-Control/blob/main/Codes/CSTR.m) solves the optimal control problem for a CSTR system (example 6.2-2 from [Kirk's book](https://books.google.com/books?hl=en&lr=&id=fCh2SAtWIdwC&oi=fnd&pg=PA1&dq=optimal+control+Kirk&ots=xziIYkb-e4&sig=fJ9SZLSPHDYESgw6TMzxO8K2HBo)).
   3. [Free time CSTR](https://github.com/MRGilak/Optimal-Control/blob/main/Codes/CSTR_freeTf.m) solves the same optimal control problem as [CSTR.m](https://github.com/MRGilak/Optimal-Control/blob/main/Codes/CSTR.m), but with free final time 
