...
To read more about linear control systems, take a look at [Frequency Analysis](frequency-analysis) or [Steady-state Behavior of Linear Systems](steady-state-behavior-of-linear-systems).