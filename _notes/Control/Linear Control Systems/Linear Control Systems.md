...
Before getting started, I have to state that by _linear control systems_ I am generally referring to the materials of the linear control systems course, which cover _continuous-time_ systems. Studying discrete-time systems will be in another series of notes, which you can find [here](digital-control-systems).
...
Learn more about control systems by reading about [First and Second-order Systems](first-and-second-order-systems) or [Steady-state Behavior of Linear Systems](steady-state-behavior-of-linear-systems).