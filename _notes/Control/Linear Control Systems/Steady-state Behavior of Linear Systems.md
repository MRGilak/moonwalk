...
We learned how to represent a linear system using differential equations and transfer functions [here](/notes/Control/Linear Control Systems/Linear Control Systems/). We also learned about first-order and second-order linear systems and their transient characteristics [here](/notes/Control/Linear Control Systems/First and Second-order Systems/). In this note, we are going to learn about the steady-state behavior of a linear system.
...
To read more about linear control systems, you can take a look at [First and Second-order Systems](/notes/Control/Linear Control Systems/First and Second-order Systems/) or [Root Locus](/notes/Control/Linear Control Systems/Root Locus/).