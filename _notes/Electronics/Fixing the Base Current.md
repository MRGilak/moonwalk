...
To calculate the gain of the system we can use its four-element model introduced [here](four-element-model-of-a-transistor). 
...
Continue learning about electronics [here](fixing-the-collector-current).