...
#Electronics 
We have learned about single-stage ac-coupled amplifiers in the previous notes (you can find the order of the notes in [this note](basics-of-electronics)). Now we want to use more amplifiers cascaded with each other in order to get a larger gain.
...
Continue with learning about the CASCODE structure [here](cascode-structure).