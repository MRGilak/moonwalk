...
#Robotics #Modeling 
To obtain a numerical model for the robotic leg, Lagrangian dynamics were first written [here](mathematical-modeling-of-a-single-leg-robot). The dynamics were then written in MATLAB to solve the equations symbolically. The final equations turned out to be much more complex than I initially assumed. The final equations of motion were then turned to several _.m_ functions to be later used for simulation.
## Final Dynamics 
