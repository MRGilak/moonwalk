...
#Robotics 
The [single leg project](single-leg-project) requires working with frames, defining angles and deriving kinematics and dynamics. Dynamics of the robot are derived [here](mathematical-modeling-of-a-single-leg-robot). Kinematics will be derived here.
