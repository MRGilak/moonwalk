...
Continue learning about algorithms by reading about [divide and conquer algorithms](divide-and-conquer-algorithms), [binary search](binary-search) or [insertion sort](insertion-sort). 
