...
>[!summary] Summary
>This paper uses model free adaptive control ([MFAC](/notes/mfac/)) to deal with any nonlinear system and make a prediction $\hat{y}(t+1)$ . This prediction is then used and based on a cost function minimization, a control law is derived.
...
This paper is based on [MFAC](/notes/mfac/).
